...
import 'package:communehub/competitions/artsinput.dart';

import 'package:flutter/material.dart';
import 'package:cloud_firestore/cloud_firestore.dart';

class CompetitionsPage2 extends StatelessWidget {
  @override
              ...
              return GestureDetector(
                onTap: () {
                  Navigator.push(
                    ...
                    MaterialPageRoute(
                      builder: (context) =>
                          CompetitionDetailsPage2(competitionData: comp),
                    ),
                  );
                },
                child: Padding(
...
class CompetitionDetailsPage2 extends StatelessWidget {
  final Map<String, dynamic> competitionData;

  CompetitionDetailsPage2({required this.competitionData});
