    ...
    try {
      ...
      if (_selectedImage != null) {
        ...
        CollectionReference collRef =
            FirebaseFirestore.instance.collection('arts');
       ...
       // nameOfCommunityController.clear();
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text('Arts competition added successfully!'),
                ...
                Container(
                  ...
                  child: TextFormField(
                    ...
                    decoration: InputDecoration(
                      hintText: 'Name of Arts Competition',
